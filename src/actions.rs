...
mod tests {
    ...
    fn test_computation_of_new_cube_position() {
        ...
        assert_eq!(Vector3::new(1., 0., 0.), 
                   cube.position_to_add_new_cube(Vector3::new(3., 0.5, 0.5), Vector3::unit_x().opposite()).unwrap());
        
        assert_eq!(Vector3::new(0., 0., 1.),
                   cube.position_to_add_new_cube(Vector3::new(0.5, 0.5, 3.5), Vector3::unit_z().opposite()).unwrap());
